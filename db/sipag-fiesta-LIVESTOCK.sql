...
INSERT INTO TECHNOLOGY ( title, description, objective_intro, commodity_id ) 
  VALUES
    ...
    (
      ...
      NULL,
      (SELECT commodity_id FROM COMMODITY WHERE name="Duck")
    ),
    /*NATIVE CHICKEN*/
    (
      ...
      NULL,
      (SELECT commodity_id FROM COMMODITY WHERE name="Native Chicken")
    ),
    /*SWINE*/
    (
      ...
      NULL,
      (SELECT commodity_id FROM COMMODITY WHERE name="Swine")
    ),
    (
      '\'Etag\' for you and me!',
    ...
    (
      ...
      NULL,
      (SELECT commodity_id FROM COMMODITY WHERE name="Goat")
    ),
    /*DAIRY BUFFALO*/
    (
      ...
      NULL,
      (SELECT commodity_id FROM COMMODITY WHERE name="Dairy Buffalo")
    ),
    /*FEED RESOURCES*/
    (
      ...
      NULL,
      (SELECT commodity_id FROM COMMODITY WHERE name="Feed Resources")
    ),
    (
      'Corn saves the day',
